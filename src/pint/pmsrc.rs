...
impl W {
    #[doc = "Bits 8:10 - Selects the input source for bit slice 0"]
    #[inline(always)]
    pub fn src0(&mut self) -> Src0W<'_, PmsrcSpec> {
        Src0W::new(self, 8)
    }
    #[doc = "Bits 11:13 - Selects the input source for bit slice 1"]
    #[inline(always)]
    pub fn src1(&mut self) -> Src1W<'_, PmsrcSpec> {
        Src1W::new(self, 11)
    }
    #[doc = "Bits 14:16 - Selects the input source for bit slice 2"]
    #[inline(always)]
    pub fn src2(&mut self) -> Src2W<'_, PmsrcSpec> {
        Src2W::new(self, 14)
    }
    #[doc = "Bits 17:19 - Selects the input source for bit slice 3"]
    #[inline(always)]
    pub fn src3(&mut self) -> Src3W<'_, PmsrcSpec> {
        Src3W::new(self, 17)
    }
    #[doc = "Bits 20:22 - Selects the input source for bit slice 4"]
    #[inline(always)]
    pub fn src4(&mut self) -> Src4W<'_, PmsrcSpec> {
        Src4W::new(self, 20)
    }
    #[doc = "Bits 23:25 - Selects the input source for bit slice 5"]
    #[inline(always)]
    pub fn src5(&mut self) -> Src5W<'_, PmsrcSpec> {
        Src5W::new(self, 23)
    }
    #[doc = "Bits 26:28 - Selects the input source for bit slice 6"]
    #[inline(always)]
    pub fn src6(&mut self) -> Src6W<'_, PmsrcSpec> {
        Src6W::new(self, 26)
    }
    #[doc = "Bits 29:31 - Selects the input source for bit slice 7"]
    #[inline(always)]
    pub fn src7(&mut self) -> Src7W<'_, PmsrcSpec> {
        Src7W::new(self, 29)
    }
}
