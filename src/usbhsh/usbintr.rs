...
impl W {
    #[doc = "Bit 2 - Port Change Detect Interrupt Enable: 1: enable 0: disable."]
    #[inline(always)]
    pub fn pcde(&mut self) -> PcdeW<'_, UsbintrSpec> {
        PcdeW::new(self, 2)
    }
    #[doc = "Bit 3 - Frame List Rollover Interrupt Enable: 1: enable 0: disable."]
    #[inline(always)]
    pub fn flre(&mut self) -> FlreW<'_, UsbintrSpec> {
        FlreW::new(self, 3)
    }
    #[doc = "Bit 16 - ATL IRQ Enable bit: 1: enable 0: disable."]
    #[inline(always)]
    pub fn atl_irq_e(&mut self) -> AtlIrqEW<'_, UsbintrSpec> {
        AtlIrqEW::new(self, 16)
    }
    #[doc = "Bit 17 - ISO IRQ Enable bit: 1: enable 0: disable."]
    #[inline(always)]
    pub fn iso_irq_e(&mut self) -> IsoIrqEW<'_, UsbintrSpec> {
        IsoIrqEW::new(self, 17)
    }
    #[doc = "Bit 18 - INT IRQ Enable bit: 1: enable 0: disable."]
    #[inline(always)]
    pub fn int_irq_e(&mut self) -> IntIrqEW<'_, UsbintrSpec> {
        IntIrqEW::new(self, 18)
    }
    #[doc = "Bit 19 - SOF Interrupt Enable bit: 1: enable 0: disable."]
    #[inline(always)]
    pub fn sof_e(&mut self) -> SofEW<'_, UsbintrSpec> {
        SofEW::new(self, 19)
    }
}
