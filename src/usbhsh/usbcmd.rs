...
pub type LpmRwuR = crate::BitReader;
#[doc = "Field `LPM_RWU` writer - bRemoteWake field."]
pub type LpmRwuW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 1 - Host Controller Reset: This control bit is used by the software to reset the host controller."]
    #[inline(always)]
    pub fn hcreset(&mut self) -> HcresetW<'_, UsbcmdSpec> {
        HcresetW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Frame List Size: This field specifies the size of the frame list."]
    #[inline(always)]
    pub fn fls(&mut self) -> FlsW<'_, UsbcmdSpec> {
        FlsW::new(self, 2)
    }
    #[doc = "Bit 7 - Light Host Controller Reset: This bit allows the driver software to reset the host controller without affecting the state of the ports."]
    #[inline(always)]
    pub fn lhcr(&mut self) -> LhcrW<'_, UsbcmdSpec> {
        LhcrW::new(self, 7)
    }
    #[doc = "Bit 8 - ATL List enabled."]
    #[inline(always)]
    pub fn atl_en(&mut self) -> AtlEnW<'_, UsbcmdSpec> {
        AtlEnW::new(self, 8)
    }
    #[doc = "Bit 9 - ISO List enabled."]
    #[inline(always)]
    pub fn iso_en(&mut self) -> IsoEnW<'_, UsbcmdSpec> {
        IsoEnW::new(self, 9)
    }
    #[doc = "Bit 10 - INT List enabled."]
    #[inline(always)]
    pub fn int_en(&mut self) -> IntEnW<'_, UsbcmdSpec> {
        IntEnW::new(self, 10)
    }
    #[doc = "Bits 24:27 - Host-Initiated Resume Duration."]
    #[inline(always)]
    pub fn hird(&mut self) -> HirdW<'_, UsbcmdSpec> {
        HirdW::new(self, 24)
    }
    #[doc = "Bit 28 - bRemoteWake field."]
    #[inline(always)]
    pub fn lpm_rwu(&mut self) -> LpmRwuW<'_, UsbcmdSpec> {
        LpmRwuW::new(self, 28)
    }
}
