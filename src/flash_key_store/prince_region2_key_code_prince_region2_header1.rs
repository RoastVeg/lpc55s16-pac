...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("PRINCE_REGION2_KEY_CODE_PRINCE_REGION2_HEADER1")
...
impl W {
    #[doc = "Bits 0:1 - ."]
    #[inline(always)]
    pub fn type_(&mut self) -> TypeW<'_, PrinceRegion2KeyCodePrinceRegion2Header1Spec> {
        TypeW::new(self, 0)
    }
    #[doc = "Bits 8:11 - ."]
    #[inline(always)]
    pub fn index(&mut self) -> IndexW<'_, PrinceRegion2KeyCodePrinceRegion2Header1Spec> {
        IndexW::new(self, 8)
    }
    #[doc = "Bits 24:29 - ."]
    #[inline(always)]
    pub fn size(&mut self) -> SizeW<'_, PrinceRegion2KeyCodePrinceRegion2Header1Spec> {
        SizeW::new(self, 24)
    }
}
