...
impl W {
    #[doc = "Bit 0 - Master Pending interrupt Enable."]
    #[inline(always)]
    pub fn mstpendingen(&mut self) -> MstpendingenW<'_, IntensetSpec> {
        MstpendingenW::new(self, 0)
    }
    #[doc = "Bit 4 - Master Arbitration Loss interrupt Enable."]
    #[inline(always)]
    pub fn mstarblossen(&mut self) -> MstarblossenW<'_, IntensetSpec> {
        MstarblossenW::new(self, 4)
    }
    #[doc = "Bit 6 - Master Start/Stop Error interrupt Enable."]
    #[inline(always)]
    pub fn mstststperren(&mut self) -> MstststperrenW<'_, IntensetSpec> {
        MstststperrenW::new(self, 6)
    }
    #[doc = "Bit 8 - Slave Pending interrupt Enable."]
    #[inline(always)]
    pub fn slvpendingen(&mut self) -> SlvpendingenW<'_, IntensetSpec> {
        SlvpendingenW::new(self, 8)
    }
    #[doc = "Bit 11 - Slave Not Stretching interrupt Enable."]
    #[inline(always)]
    pub fn slvnotstren(&mut self) -> SlvnotstrenW<'_, IntensetSpec> {
        SlvnotstrenW::new(self, 11)
    }
    #[doc = "Bit 15 - Slave Deselect interrupt Enable."]
    #[inline(always)]
    pub fn slvdeselen(&mut self) -> SlvdeselenW<'_, IntensetSpec> {
        SlvdeselenW::new(self, 15)
    }
    #[doc = "Bit 16 - Monitor data Ready interrupt Enable."]
    #[inline(always)]
    pub fn monrdyen(&mut self) -> MonrdyenW<'_, IntensetSpec> {
        MonrdyenW::new(self, 16)
    }
    #[doc = "Bit 17 - Monitor Overrun interrupt Enable."]
    #[inline(always)]
    pub fn monoven(&mut self) -> MonovenW<'_, IntensetSpec> {
        MonovenW::new(self, 17)
    }
    #[doc = "Bit 19 - Monitor Idle interrupt Enable."]
    #[inline(always)]
    pub fn monidleen(&mut self) -> MonidleenW<'_, IntensetSpec> {
        MonidleenW::new(self, 19)
    }
    #[doc = "Bit 24 - Event time-out interrupt Enable."]
    #[inline(always)]
    pub fn eventtimeouten(&mut self) -> EventtimeoutenW<'_, IntensetSpec> {
        EventtimeoutenW::new(self, 24)
    }
    #[doc = "Bit 25 - SCL time-out interrupt Enable."]
    #[inline(always)]
    pub fn scltimeouten(&mut self) -> ScltimeoutenW<'_, IntensetSpec> {
