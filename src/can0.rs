...
pub mod txefa;
#[doc = "MRBA (rw) register accessor: CAN Message RAM Base Address\n\nYou can [`read`](crate::Reg::read) this register and get [`mrba::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mrba::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@mrba`] module"]
#[doc(alias = "MRBA")]
pub type Mrba = crate::Reg<mrba::MrbaSpec>;
#[doc = "CAN Message RAM Base Address"]
pub mod mrba;
#[doc = "ETSCC (rw) register accessor: External Timestamp Counter Configuration\n\nYou can [`read`](crate::Reg::read) this register and get [`etscc::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`etscc::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@etscc`] module"]
#[doc(alias = "ETSCC")]
pub type Etscc = crate::Reg<etscc::EtsccSpec>;
#[doc = "External Timestamp Counter Configuration"]
pub mod etscc;
#[doc = "ETSCV (rw) register accessor: External Timestamp Counter Value\n\nYou can [`read`](crate::Reg::read) this register and get [`etscv::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`etscv::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@etscv`] module"]
#[doc(alias = "ETSCV")]
pub type Etscv = crate::Reg<etscv::EtscvSpec>;
