...
impl W {
    #[doc = "Bit 0 - Non Secure non-invasive debug fixed state"]
    #[inline(always)]
    pub fn niden(&mut self) -> NidenW<'_, CcSocuDfltSpec> {
        NidenW::new(self, 0)
    }
    #[doc = "Bit 1 - Non Secure debug fixed state"]
    #[inline(always)]
    pub fn dbgen(&mut self) -> DbgenW<'_, CcSocuDfltSpec> {
        DbgenW::new(self, 1)
    }
    #[doc = "Bit 2 - Secure non-invasive debug fixed state"]
    #[inline(always)]
    pub fn spniden(&mut self) -> SpnidenW<'_, CcSocuDfltSpec> {
        SpnidenW::new(self, 2)
    }
    #[doc = "Bit 3 - Secure invasive debug fixed state"]
    #[inline(always)]
    pub fn spiden(&mut self) -> SpidenW<'_, CcSocuDfltSpec> {
        SpidenW::new(self, 3)
    }
    #[doc = "Bit 4 - JTAG TAP fixed state"]
    #[inline(always)]
    pub fn tapen(&mut self) -> TapenW<'_, CcSocuDfltSpec> {
        TapenW::new(self, 4)
    }
    #[doc = "Bit 6 - ISP Boot Command fixed state"]
    #[inline(always)]
    pub fn isp_cmd_en(&mut self) -> IspCmdEnW<'_, CcSocuDfltSpec> {
        IspCmdEnW::new(self, 6)
    }
    #[doc = "Bit 7 - FA Command fixed state"]
    #[inline(always)]
    pub fn fa_me_cmd_en(&mut self) -> FaMeCmdEnW<'_, CcSocuDfltSpec> {
        FaMeCmdEnW::new(self, 7)
    }
    #[doc = "Bits 16:31 - inverse value of bits \\[15:0\\]"]
    #[inline(always)]
    pub fn inverse_value(&mut self) -> InverseValueW<'_, CcSocuDfltSpec> {
