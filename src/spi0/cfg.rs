...
impl W {
    ...
    #[doc = "Bit 2 - Master mode select."]
    #[inline(always)]
    pub fn master(&mut self) -> MasterW<'_, CfgSpec> {
        MasterW::new(self, 2)
    }
    #[doc = "Bit 3 - LSB First mode enable."]
    #[inline(always)]
    pub fn lsbf(&mut self) -> LsbfW<'_, CfgSpec> {
        LsbfW::new(self, 3)
    }
    #[doc = "Bit 4 - Clock Phase select."]
    #[inline(always)]
    pub fn cpha(&mut self) -> CphaW<'_, CfgSpec> {
        CphaW::new(self, 4)
    }
    #[doc = "Bit 5 - Clock Polarity select."]
    #[inline(always)]
    pub fn cpol(&mut self) -> CpolW<'_, CfgSpec> {
        CpolW::new(self, 5)
    }
    #[doc = "Bit 7 - Loopback mode enable. Loopback mode applies only to Master mode, and connects transmit and receive data connected together to allow simple software testing."]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - SSEL0 Polarity select."]
    #[inline(always)]
    pub fn spol0(&mut self) -> Spol0W<'_, CfgSpec> {
        Spol0W::new(self, 8)
    }
    #[doc = "Bit 9 - SSEL1 Polarity select."]
    #[inline(always)]
    pub fn spol1(&mut self) -> Spol1W<'_, CfgSpec> {
        Spol1W::new(self, 9)
    }
    #[doc = "Bit 10 - SSEL2 Polarity select."]
    #[inline(always)]
    pub fn spol2(&mut self) -> Spol2W<'_, CfgSpec> {
        Spol2W::new(self, 10)
    }
    #[doc = "Bit 11 - SSEL3 Polarity select."]
    #[inline(always)]
    pub fn spol3(&mut self) -> Spol3W<'_, CfgSpec> {
        Spol3W::new(self, 11)
    }
}
