...
pub enum Txignore {
    ...
    Write = 0,
    #[doc = "1: Ignore transmit data. Data can be received without transmitting data (after FIFOWR has been initialized to set TXIGNORE). No transmitter flags are generated. When configured with TXIGNORE =1, the slave will set the data to always 0."]
    Ignore = 1,
}
...
#[doc = "Field `TXIGNORE` writer - Transmit Ignore. This allows data to be received using the SPI without the need to read unneeded data from the receiver. Setting this bit simplifies the transmit process and can be used with the DMA.This bit can only be set by writing to the upper 16 bits only of FIFOWR, i.e., a half-word write to offset 0xE22."]
...
impl W {
    ...
    #[inline(always)]
    pub fn txssel1_n(&mut self) -> Txssel1NW<'_, FifowrSpec> {
    ...
    #[inline(always)]
    pub fn txssel2_n(&mut self) -> Txssel2NW<'_, FifowrSpec> {
    ...
    #[inline(always)]
    pub fn txssel3_n(&mut self) -> Txssel3NW<'_, FifowrSpec> {
    ...
    #[inline(always)]
    pub fn eot(&mut self) -> EotW<'_, FifowrSpec> {
        EotW::new(self, 20)
    }
    ...
    #[inline(always)]
    pub fn eof(&mut self) -> EofW<'_, FifowrSpec> {
        EofW::new(self, 21)
    }
    ...
    #[inline(always)]
    pub fn rxignore(&mut self) -> RxignoreW<'_, FifowrSpec> {
        RxignoreW::new(self, 22)
    }
    #[doc = "Bit 23 - Transmit Ignore. This allows data to be received using the SPI without the need to read unneeded data from the receiver. Setting this bit simplifies the transmit process and can be used with the DMA.This bit can only be set by writing to the upper 16 bits only of FIFOWR, i.e., a half-word write to offset 0xE22."]
    #[inline(always)]
    pub fn txignore(&mut self) -> TxignoreW<'_, FifowrSpec> {
        TxignoreW::new(self, 23)
    }
    #[doc = "Bits 24:27 - Data Length. Specifies the data length from 4 to 16 bits. Note that transfer lengths greater than 16 bits are supported by implementing multiple sequential transmits. 0x0-2 = Reserved. 0x3 = Data transfer is 4 bits in length. 0x4 = Data transfer is 5 bits in length. 0xF = Data transfer is 16 bits in length."]
    #[inline(always)]
    pub fn len(&mut self) -> LenW<'_, FifowrSpec> {
        LenW::new(self, 24)
    }
}
