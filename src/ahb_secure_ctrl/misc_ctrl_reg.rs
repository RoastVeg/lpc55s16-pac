...
impl W {
    #[doc = "Bits 0:1 - Write lock."]
    #[inline(always)]
    pub fn write_lock(&mut self) -> WriteLockW<'_, MiscCtrlRegSpec> {
        WriteLockW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Enable secure check for AHB matrix."]
    #[inline(always)]
    pub fn enable_secure_checking(&mut self) -> EnableSecureCheckingW<'_, MiscCtrlRegSpec> {
        EnableSecureCheckingW::new(self, 2)
    }
    #[doc = "Bits 4:5 - Enable secure privilege check for AHB matrix."]
    #[inline(always)]
    pub fn enable_s_priv_check(&mut self) -> EnableSPrivCheckW<'_, MiscCtrlRegSpec> {
        EnableSPrivCheckW::new(self, 4)
    }
    #[doc = "Bits 6:7 - Enable non-secure privilege check for AHB matrix."]
    #[inline(always)]
    pub fn enable_ns_priv_check(&mut self) -> EnableNsPrivCheckW<'_, MiscCtrlRegSpec> {
        EnableNsPrivCheckW::new(self, 6)
    }
    #[doc = "Bits 8:9 - Disable secure violation abort."]
    #[inline(always)]
    pub fn disable_violation_abort(&mut self) -> DisableViolationAbortW<'_, MiscCtrlRegSpec> {
    ...
    pub fn disable_simple_master_strict_mode(
        &mut self,
    ) -> DisableSimpleMasterStrictModeW<'_, MiscCtrlRegSpec> {
    ...
    pub fn disable_smart_master_strict_mode(
        &mut self,
    ) -> DisableSmartMasterStrictModeW<'_, MiscCtrlRegSpec> {
        DisableSmartMasterStrictModeW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Disable IDAU."]
    #[inline(always)]
    pub fn idau_all_ns(&mut self) -> IdauAllNsW<'_, MiscCtrlRegSpec> {
