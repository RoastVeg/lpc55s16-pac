...
impl W {
    #[doc = "Bits 0:1 - secure control rule0. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule0(&mut self) -> Rule0W<'_, SecCtrlRomMemRule1Spec> {
        Rule0W::new(self, 0)
    }
    #[doc = "Bits 4:5 - secure control rule1. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule1(&mut self) -> Rule1W<'_, SecCtrlRomMemRule1Spec> {
        Rule1W::new(self, 4)
    }
    #[doc = "Bits 8:9 - secure control rule2. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule2(&mut self) -> Rule2W<'_, SecCtrlRomMemRule1Spec> {
        Rule2W::new(self, 8)
    }
    #[doc = "Bits 12:13 - secure control rule3. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule3(&mut self) -> Rule3W<'_, SecCtrlRomMemRule1Spec> {
        Rule3W::new(self, 12)
    }
    #[doc = "Bits 16:17 - secure control rule4. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule4(&mut self) -> Rule4W<'_, SecCtrlRomMemRule1Spec> {
        Rule4W::new(self, 16)
    }
    #[doc = "Bits 20:21 - secure control rule5. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule5(&mut self) -> Rule5W<'_, SecCtrlRomMemRule1Spec> {
        Rule5W::new(self, 20)
    }
    #[doc = "Bits 24:25 - secure control rule6. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule6(&mut self) -> Rule6W<'_, SecCtrlRomMemRule1Spec> {
        Rule6W::new(self, 24)
    }
    #[doc = "Bits 28:29 - secure control rule7. it can be set when check_reg's write_lock is '0'"]
    #[inline(always)]
    pub fn rule7(&mut self) -> Rule7W<'_, SecCtrlRomMemRule1Spec> {
        Rule7W::new(self, 28)
    }
}
