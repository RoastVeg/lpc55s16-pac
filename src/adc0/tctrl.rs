...
impl W {
    #[doc = "Bit 0 - Trigger enable"]
    #[inline(always)]
    pub fn hten(&mut self) -> HtenW<'_, TctrlSpec> {
        HtenW::new(self, 0)
    }
    #[doc = "Bit 1 - SAR Result Destination For Channel A"]
    #[inline(always)]
    pub fn fifo_sel_a(&mut self) -> FifoSelAW<'_, TctrlSpec> {
        FifoSelAW::new(self, 1)
    }
    #[doc = "Bit 2 - SAR Result Destination For Channel B"]
    #[inline(always)]
    pub fn fifo_sel_b(&mut self) -> FifoSelBW<'_, TctrlSpec> {
        FifoSelBW::new(self, 2)
    }
    #[doc = "Bits 8:11 - Trigger priority setting"]
    #[inline(always)]
    pub fn tpri(&mut self) -> TpriW<'_, TctrlSpec> {
        TpriW::new(self, 8)
    }
    #[doc = "Bit 15 - Trigger Resync"]
    #[inline(always)]
    pub fn rsync(&mut self) -> RsyncW<'_, TctrlSpec> {
        RsyncW::new(self, 15)
    }
    #[doc = "Bits 16:19 - Trigger delay select"]
    #[inline(always)]
    pub fn tdly(&mut self) -> TdlyW<'_, TctrlSpec> {
        TdlyW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Trigger command select"]
    #[inline(always)]
    pub fn tcmd(&mut self) -> TcmdW<'_, TctrlSpec> {
        TcmdW::new(self, 24)
    }
}
