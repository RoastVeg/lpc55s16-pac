...
impl W {
    #[doc = "Bits 0:1 - Compare Function Enable"]
    #[inline(always)]
    pub fn cmpen(&mut self) -> CmpenW<'_, Cmdh2Spec> {
        CmpenW::new(self, 0)
    }
    #[doc = "Bit 2 - Wait for trigger assertion before execution."]
    #[inline(always)]
    pub fn wait_trig(&mut self) -> WaitTrigW<'_, Cmdh2Spec> {
        WaitTrigW::new(self, 2)
    }
    #[doc = "Bit 7 - Loop with Increment"]
    #[inline(always)]
    pub fn lwi(&mut self) -> LwiW<'_, Cmdh2Spec> {
        LwiW::new(self, 7)
    }
    #[doc = "Bits 8:10 - Sample Time Select"]
    #[inline(always)]
    pub fn sts(&mut self) -> StsW<'_, Cmdh2Spec> {
        StsW::new(self, 8)
    }
    #[doc = "Bits 12:14 - Hardware Average Select"]
    #[inline(always)]
    pub fn avgs(&mut self) -> AvgsW<'_, Cmdh2Spec> {
        AvgsW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Loop Count Select"]
    #[inline(always)]
    pub fn loop_(&mut self) -> LoopW<'_, Cmdh2Spec> {
        LoopW::new(self, 16)
    }
    #[doc = "Bits 24:27 - Next Command Select"]
    #[inline(always)]
    pub fn next(&mut self) -> NextW<'_, Cmdh2Spec> {
        NextW::new(self, 24)
    }
}
