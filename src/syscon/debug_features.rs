...
impl W {
    #[doc = "Bits 0:1 - CPU0 Invasive debug control:."]
    #[inline(always)]
    pub fn cpu0_dbgen(&mut self) -> Cpu0DbgenW<'_, DebugFeaturesSpec> {
        Cpu0DbgenW::new(self, 0)
    }
    #[doc = "Bits 2:3 - CPU0 Non Invasive debug control:."]
    #[inline(always)]
    pub fn cpu0_niden(&mut self) -> Cpu0NidenW<'_, DebugFeaturesSpec> {
        Cpu0NidenW::new(self, 2)
    }
    #[doc = "Bits 4:5 - CPU0 Secure Invasive debug control:."]
    #[inline(always)]
    pub fn cpu0_spiden(&mut self) -> Cpu0SpidenW<'_, DebugFeaturesSpec> {
        Cpu0SpidenW::new(self, 4)
    }
    #[doc = "Bits 6:7 - CPU0 Secure Non Invasive debug control:."]
    #[inline(always)]
    pub fn cpu0_spniden(&mut self) -> Cpu0SpnidenW<'_, DebugFeaturesSpec> {
