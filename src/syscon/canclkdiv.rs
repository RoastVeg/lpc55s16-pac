#[doc = "Register `CANCLKDIV` reader"]
pub type R = crate::R<CanclkdivSpec>;
#[doc = "Register `CANCLKDIV` writer"]
pub type W = crate::W<CanclkdivSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock divider value."]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, CanclkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter."]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, CanclkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter."]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, CanclkdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "CAN clock divider\n\nYou can [`read`](crate::Reg::read) this register and get [`canclkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`canclkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CanclkdivSpec;
impl crate::RegisterSpec for CanclkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`canclkdiv::R`](R) reader structure"]
impl crate::Readable for CanclkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`canclkdiv::W`](W) writer structure"]
impl crate::Writable for CanclkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CANCLKDIV to value 0x4000_0000"]
impl crate::Resettable for CanclkdivSpec {
