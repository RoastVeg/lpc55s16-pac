...
pub type R = crate::R<CanclkselSpec>;
#[doc = "Register `CANCLKSEL` writer"]
pub type W = crate::W<CanclkselSpec>;
...
impl W {
    #[doc = "Bits 0:2 - CAN clock source select."]
    #[inline(always)]
    pub fn sel(&mut self) -> SelW<'_, CanclkselSpec> {
        SelW::new(self, 0)
    }
}
#[doc = "CAN clock source select\n\nYou can [`read`](crate::Reg::read) this register and get [`canclksel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`canclksel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct CanclkselSpec;
impl crate::RegisterSpec for CanclkselSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`canclksel::R`](R) reader structure"]
impl crate::Readable for CanclkselSpec {}
#[doc = "`write(|w| ..)` method takes [`canclksel::W`](W) writer structure"]
impl crate::Writable for CanclkselSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets CANCLKSEL to value 0x07"]
impl crate::Resettable for CanclkselSpec {
