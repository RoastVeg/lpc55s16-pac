#[doc = "Register `FRO1MCLKDIV` reader"]
pub type R = crate::R<Fro1mclkdivSpec>;
#[doc = "Register `FRO1MCLKDIV` writer"]
pub type W = crate::W<Fro1mclkdivSpec>;
...
impl W {
    #[doc = "Bits 0:7 - Clock divider value."]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<'_, Fro1mclkdivSpec> {
        DivW::new(self, 0)
    }
    #[doc = "Bit 29 - Resets the divider counter."]
    #[inline(always)]
    pub fn reset(&mut self) -> ResetW<'_, Fro1mclkdivSpec> {
        ResetW::new(self, 29)
    }
    #[doc = "Bit 30 - Halts the divider counter."]
    #[inline(always)]
    pub fn halt(&mut self) -> HaltW<'_, Fro1mclkdivSpec> {
        HaltW::new(self, 30)
    }
}
#[doc = "FRO1MHz Clock divider (FRO1M_divided)\n\nYou can [`read`](crate::Reg::read) this register and get [`fro1mclkdiv::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fro1mclkdiv::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Fro1mclkdivSpec;
impl crate::RegisterSpec for Fro1mclkdivSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`fro1mclkdiv::R`](R) reader structure"]
impl crate::Readable for Fro1mclkdivSpec {}
#[doc = "`write(|w| ..)` method takes [`fro1mclkdiv::W`](W) writer structure"]
impl crate::Writable for Fro1mclkdivSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets FRO1MCLKDIV to value 0x4000_001f"]
impl crate::Resettable for Fro1mclkdivSpec {
    const RESET_VALUE: u32 = 0x4000_001f;
}
