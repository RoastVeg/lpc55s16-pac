...
pub enum DevNeedclk {
    ...
    Low = 0,
    #[doc = "1: USB0-FS Device clock is high."]
    High = 1,
}
...
#[doc = "Field `DEV_NEEDCLK` reader - USB0-FS Device USB0_NEEDCLK signal status:."]
...
pub enum HostNeedclk {
    ...
    Low = 0,
    #[doc = "1: USB0-FS Host clock is high."]
    High = 1,
}
...
#[doc = "Field `HOST_NEEDCLK` reader - USB0-FS Host USB0_NEEDCLK signal status:."]
...
impl R {
    #[doc = "Bit 0 - USB0-FS Device USB0_NEEDCLK signal status:."]
    #[inline(always)]
    pub fn dev_needclk(&self) -> DevNeedclkR {
        DevNeedclkR::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - USB0-FS Host USB0_NEEDCLK signal status:."]
    #[inline(always)]
