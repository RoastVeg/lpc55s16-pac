...
impl W {
    #[doc = "Bits 0:3 - Selects pin function."]
    #[inline(always)]
    pub fn func(&mut self) -> FuncW<'_, Pio1_13Spec> {
        FuncW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<'_, Pio1_13Spec> {
        ModeW::new(self, 4)
    }
    #[doc = "Bit 6 - Driver slew rate."]
    #[inline(always)]
    pub fn slew(&mut self) -> SlewW<'_, Pio1_13Spec> {
        SlewW::new(self, 6)
    }
    #[doc = "Bit 7 - Input polarity."]
    #[inline(always)]
    pub fn invert(&mut self) -> InvertW<'_, Pio1_13Spec> {
        InvertW::new(self, 7)
    }
    #[doc = "Bit 8 - Select Digital mode."]
    #[inline(always)]
    pub fn digimode(&mut self) -> DigimodeW<'_, Pio1_13Spec> {
        DigimodeW::new(self, 8)
    }
    #[doc = "Bit 9 - Controls open-drain mode."]
    #[inline(always)]
    pub fn od(&mut self) -> OdW<'_, Pio1_13Spec> {
        OdW::new(self, 9)
    }
}
