...
impl W {
    #[doc = "Bit 0 - Monitors the interrupt flag of TIMER0."]
    #[inline(always)]
    pub fn gflag0(&mut self) -> Gflag0W<'_, IrqFlagSpec> {
        Gflag0W::new(self, 0)
    }
    #[doc = "Bit 1 - Monitors the interrupt flag of TIMER1. See description of channel 0."]
    #[inline(always)]
    pub fn gflag1(&mut self) -> Gflag1W<'_, IrqFlagSpec> {
        Gflag1W::new(self, 1)
    }
    #[doc = "Bit 2 - Monitors the interrupt flag of TIMER2. See description of channel 0."]
    #[inline(always)]
    pub fn gflag2(&mut self) -> Gflag2W<'_, IrqFlagSpec> {
        Gflag2W::new(self, 2)
    }
    #[doc = "Bit 3 - Monitors the interrupt flag of TIMER3. See description of channel 0."]
    #[inline(always)]
    pub fn gflag3(&mut self) -> Gflag3W<'_, IrqFlagSpec> {
        Gflag3W::new(self, 3)
    }
}
