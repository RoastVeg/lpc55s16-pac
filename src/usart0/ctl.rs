...
impl W {
    #[doc = "Bit 1 - Break Enable."]
    #[inline(always)]
    pub fn txbrken(&mut self) -> TxbrkenW<'_, CtlSpec> {
        TxbrkenW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable address detect mode."]
    #[inline(always)]
    pub fn addrdet(&mut self) -> AddrdetW<'_, CtlSpec> {
        AddrdetW::new(self, 2)
    }
    #[doc = "Bit 6 - Transmit Disable."]
    #[inline(always)]
    pub fn txdis(&mut self) -> TxdisW<'_, CtlSpec> {
        TxdisW::new(self, 6)
    }
    #[doc = "Bit 8 - Continuous Clock generation. By default, SCLK is only output while data is being transmitted in synchronous mode."]
    #[inline(always)]
    pub fn cc(&mut self) -> CcW<'_, CtlSpec> {
        CcW::new(self, 8)
    }
    #[doc = "Bit 9 - Clear Continuous Clock."]
    #[inline(always)]
    pub fn clrcconrx(&mut self) -> ClrcconrxW<'_, CtlSpec> {
        ClrcconrxW::new(self, 9)
    }
    #[doc = "Bit 16 - Autobaud enable."]
    #[inline(always)]
    pub fn autobaud(&mut self) -> AutobaudW<'_, CtlSpec> {
