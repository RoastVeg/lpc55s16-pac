...
impl W {
    ...
    #[inline(always)]
    pub fn deltacts(&mut self) -> DeltactsW<'_, StatSpec> {
    ...
    #[inline(always)]
    pub fn deltarxbrk(&mut self) -> DeltarxbrkW<'_, StatSpec> {
    ...
    #[inline(always)]
    pub fn start(&mut self) -> StartW<'_, StatSpec> {
        StartW::new(self, 12)
    }
    ...
    #[inline(always)]
    pub fn framerrint(&mut self) -> FramerrintW<'_, StatSpec> {
    ...
    #[inline(always)]
    pub fn parityerrint(&mut self) -> ParityerrintW<'_, StatSpec> {
    ...
    #[inline(always)]
    pub fn rxnoiseint(&mut self) -> RxnoiseintW<'_, StatSpec> {
    ...
    #[inline(always)]
    pub fn aberr(&mut self) -> AberrW<'_, StatSpec> {
        AberrW::new(self, 16)
    }
}
