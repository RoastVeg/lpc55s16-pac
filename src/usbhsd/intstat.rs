...
impl W {
    #[doc = "Bit 0 - Interrupt status register bit for the Control EP0 OUT direction."]
    #[inline(always)]
    pub fn ep0out(&mut self) -> Ep0outW<'_, IntstatSpec> {
        Ep0outW::new(self, 0)
    }
    #[doc = "Bit 1 - Interrupt status register bit for the Control EP0 IN direction."]
    #[inline(always)]
    pub fn ep0in(&mut self) -> Ep0inW<'_, IntstatSpec> {
        Ep0inW::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt status register bit for the EP1 OUT direction."]
    #[inline(always)]
    pub fn ep1out(&mut self) -> Ep1outW<'_, IntstatSpec> {
        Ep1outW::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt status register bit for the EP1 IN direction."]
    #[inline(always)]
    pub fn ep1in(&mut self) -> Ep1inW<'_, IntstatSpec> {
        Ep1inW::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt status register bit for the EP2 OUT direction."]
    #[inline(always)]
    pub fn ep2out(&mut self) -> Ep2outW<'_, IntstatSpec> {
        Ep2outW::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt status register bit for the EP2 IN direction."]
    #[inline(always)]
    pub fn ep2in(&mut self) -> Ep2inW<'_, IntstatSpec> {
        Ep2inW::new(self, 5)
    }
    #[doc = "Bit 6 - Interrupt status register bit for the EP3 OUT direction."]
    #[inline(always)]
    pub fn ep3out(&mut self) -> Ep3outW<'_, IntstatSpec> {
        Ep3outW::new(self, 6)
    }
    #[doc = "Bit 7 - Interrupt status register bit for the EP3 IN direction."]
    #[inline(always)]
    pub fn ep3in(&mut self) -> Ep3inW<'_, IntstatSpec> {
        Ep3inW::new(self, 7)
    }
    #[doc = "Bit 8 - Interrupt status register bit for the EP4 OUT direction."]
    #[inline(always)]
    pub fn ep4out(&mut self) -> Ep4outW<'_, IntstatSpec> {
        Ep4outW::new(self, 8)
    }
    #[doc = "Bit 9 - Interrupt status register bit for the EP4 IN direction."]
    #[inline(always)]
    pub fn ep4in(&mut self) -> Ep4inW<'_, IntstatSpec> {
        Ep4inW::new(self, 9)
    }
    #[doc = "Bit 10 - Interrupt status register bit for the EP5 OUT direction."]
    #[inline(always)]
    pub fn ep5out(&mut self) -> Ep5outW<'_, IntstatSpec> {
        Ep5outW::new(self, 10)
    }
    #[doc = "Bit 11 - Interrupt status register bit for the EP5 IN direction."]
    #[inline(always)]
    pub fn ep5in(&mut self) -> Ep5inW<'_, IntstatSpec> {
        Ep5inW::new(self, 11)
    }
    #[doc = "Bit 30 - Frame interrupt."]
    #[inline(always)]
    pub fn frame_int(&mut self) -> FrameIntW<'_, IntstatSpec> {
        FrameIntW::new(self, 30)
    }
    #[doc = "Bit 31 - Device status interrupt."]
    #[inline(always)]
    pub fn dev_int(&mut self) -> DevIntW<'_, IntstatSpec> {
        DevIntW::new(self, 31)
    }
}
