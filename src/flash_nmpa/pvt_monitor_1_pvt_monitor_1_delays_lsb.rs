...
pub type R = crate::R<PvtMonitor1PvtMonitor1DelaysLsbSpec>;
#[doc = "Register `PVT_MONITOR_1_DELAYS_LSB` writer"]
pub type W = crate::W<PvtMonitor1PvtMonitor1DelaysLsbSpec>;
...
impl W {
    #[doc = "Bit 0 - no description available"]
    #[inline(always)]
    pub fn delay_valid(&mut self) -> DelayValidW<'_, PvtMonitor1PvtMonitor1DelaysLsbSpec> {
        DelayValidW::new(self, 0)
    }
    #[doc = "Bits 1:10 - Delay in us."]
    #[inline(always)]
    pub fn delay_0(&mut self) -> Delay0W<'_, PvtMonitor1PvtMonitor1DelaysLsbSpec> {
        Delay0W::new(self, 1)
    }
    #[doc = "Bits 11:20 - Delay in us."]
    #[inline(always)]
    pub fn delay_1(&mut self) -> Delay1W<'_, PvtMonitor1PvtMonitor1DelaysLsbSpec> {
        Delay1W::new(self, 11)
    }
    #[doc = "Bits 21:30 - Delay in us."]
    #[inline(always)]
    pub fn delay_2(&mut self) -> Delay2W<'_, PvtMonitor1PvtMonitor1DelaysLsbSpec> {
        Delay2W::new(self, 21)
    }
}
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`pvt_monitor_1_pvt_monitor_1_delays_lsb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pvt_monitor_1_pvt_monitor_1_delays_lsb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PvtMonitor1PvtMonitor1DelaysLsbSpec;
impl crate::RegisterSpec for PvtMonitor1PvtMonitor1DelaysLsbSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`pvt_monitor_1_pvt_monitor_1_delays_lsb::R`](R) reader structure"]
impl crate::Readable for PvtMonitor1PvtMonitor1DelaysLsbSpec {}
#[doc = "`write(|w| ..)` method takes [`pvt_monitor_1_pvt_monitor_1_delays_lsb::W`](W) writer structure"]
impl crate::Writable for PvtMonitor1PvtMonitor1DelaysLsbSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets PVT_MONITOR_1_DELAYS_LSB to value 0"]
impl crate::Resettable for PvtMonitor1PvtMonitor1DelaysLsbSpec {}
