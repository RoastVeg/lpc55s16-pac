#[doc = "Register `AUX_BIAS_CURVE_TEMP_0` reader"]
pub type R = crate::R<AuxBiasCurveTempAuxBiasCurveTemp0Spec>;
#[doc = "Register `AUX_BIAS_CURVE_TEMP_0` writer"]
pub type W = crate::W<AuxBiasCurveTempAuxBiasCurveTemp0Spec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("AUX_BIAS_CURVE_TEMP_AUX_BIAS_CURVE_TEMP_0")
...
impl W {
    ...
    pub fn vref1vcurvetrim_0(
        &mut self,
    ) -> Vref1vcurvetrim0W<'_, AuxBiasCurveTempAuxBiasCurveTemp0Spec> {
    ...
    pub fn vref1vcurvetrim_1(
        &mut self,
    ) -> Vref1vcurvetrim1W<'_, AuxBiasCurveTempAuxBiasCurveTemp0Spec> {
        Vref1vcurvetrim1W::new(self, 16)
    }
}
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`aux_bias_curve_temp_aux_bias_curve_temp_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`aux_bias_curve_temp_aux_bias_curve_temp_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AuxBiasCurveTempAuxBiasCurveTemp0Spec;
impl crate::RegisterSpec for AuxBiasCurveTempAuxBiasCurveTemp0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`aux_bias_curve_temp_aux_bias_curve_temp_0::R`](R) reader structure"]
impl crate::Readable for AuxBiasCurveTempAuxBiasCurveTemp0Spec {}
#[doc = "`write(|w| ..)` method takes [`aux_bias_curve_temp_aux_bias_curve_temp_0::W`](W) writer structure"]
impl crate::Writable for AuxBiasCurveTempAuxBiasCurveTemp0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets AUX_BIAS_CURVE_TEMP_0 to value 0"]
impl crate::Resettable for AuxBiasCurveTempAuxBiasCurveTemp0Spec {}
