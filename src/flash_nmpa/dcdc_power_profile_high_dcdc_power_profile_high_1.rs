...
pub type R = crate::R<DcdcPowerProfileHighDcdcPowerProfileHigh1Spec>;
#[doc = "Register `DCDC_POWER_PROFILE_HIGH_1` writer"]
pub type W = crate::W<DcdcPowerProfileHighDcdcPowerProfileHigh1Spec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DCDC_POWER_PROFILE_HIGH_DCDC_POWER_PROFILE_HIGH_1")
...
impl W {
    #[doc = "Bits 0:3 - Adjust the offset voltage of BJT based comparator."]
    #[inline(always)]
    pub fn rtrimoffet(&mut self) -> RtrimoffetW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
        RtrimoffetW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Adjust Max inductor peak current limiting."]
    #[inline(always)]
    pub fn rsensetrim(&mut self) -> RsensetrimW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
    ...
    pub fn dtestenable(
        &mut self,
    ) -> DtestenableW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
        DtestenableW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Bandgap calibration parameter."]
    #[inline(always)]
    pub fn setcurve(&mut self) -> SetcurveW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
        SetcurveW::new(self, 9)
    }
    #[doc = "Bits 11:14 - Bandgap calibration parameter."]
    #[inline(always)]
    pub fn setdc(&mut self) -> SetdcW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
        SetdcW::new(self, 11)
    }
    #[doc = "Bits 15:17 - Select the output signal for test."]
    #[inline(always)]
    pub fn dtestsel(&mut self) -> DtestselW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
    ...
    pub fn iscaleenable(
        &mut self,
    ) -> IscaleenableW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
    ...
    pub fn forcebypass(
        &mut self,
    ) -> ForcebypassW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
    ...
    pub fn trimautocot(
        &mut self,
    ) -> TrimautocotW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
    ...
    pub fn forcefullcycle(
        &mut self,
    ) -> ForcefullcycleW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
        ForcefullcycleW::new(self, 24)
    }
    #[doc = "Bit 25 - Change the range of the peak detector of current inside the inductor."]
    #[inline(always)]
    pub fn lcenable(&mut self) -> LcenableW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
        LcenableW::new(self, 25)
    }
    #[doc = "Bits 26:30 - Constant Off-Time calibration input."]
    #[inline(always)]
    pub fn toff(&mut self) -> ToffW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
        ToffW::new(self, 26)
    }
    #[doc = "Bit 31 - Enable Constant Off-Time feature."]
    #[inline(always)]
    pub fn toffenable(&mut self) -> ToffenableW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh1Spec> {
        ToffenableW::new(self, 31)
    }
}
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`dcdc_power_profile_high_dcdc_power_profile_high_1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dcdc_power_profile_high_dcdc_power_profile_high_1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DcdcPowerProfileHighDcdcPowerProfileHigh1Spec;
impl crate::RegisterSpec for DcdcPowerProfileHighDcdcPowerProfileHigh1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dcdc_power_profile_high_dcdc_power_profile_high_1::R`](R) reader structure"]
impl crate::Readable for DcdcPowerProfileHighDcdcPowerProfileHigh1Spec {}
#[doc = "`write(|w| ..)` method takes [`dcdc_power_profile_high_dcdc_power_profile_high_1::W`](W) writer structure"]
impl crate::Writable for DcdcPowerProfileHighDcdcPowerProfileHigh1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DCDC_POWER_PROFILE_HIGH_1 to value 0"]
impl crate::Resettable for DcdcPowerProfileHighDcdcPowerProfileHigh1Spec {}
