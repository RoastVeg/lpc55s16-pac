...
pub type R = crate::R<DcdcPowerProfileHighDcdcPowerProfileHigh0Spec>;
#[doc = "Register `DCDC_POWER_PROFILE_HIGH_0` writer"]
pub type W = crate::W<DcdcPowerProfileHighDcdcPowerProfileHigh0Spec>;
...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DCDC_POWER_PROFILE_HIGH_DCDC_POWER_PROFILE_HIGH_0")
...
impl W {
    ...
    pub fn dcdc_trim_valid(
        &mut self,
    ) -> DcdcTrimValidW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
        DcdcTrimValidW::new(self, 0)
    }
    #[doc = "Bits 1:6 - Constant On-Time calibration."]
    #[inline(always)]
    pub fn rc(&mut self) -> RcW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
        RcW::new(self, 1)
    }
    #[doc = "Bits 7:8 - Select the type of ZCD comparator."]
    #[inline(always)]
    pub fn icomp(&mut self) -> IcompW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
        IcompW::new(self, 7)
    }
    #[doc = "Bits 9:10 - Alter Internal biasing currents."]
    #[inline(always)]
    pub fn isel(&mut self) -> IselW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
        IselW::new(self, 9)
    }
    #[doc = "Bit 11 - Selection of auto scaling of COT period with variations in VDD."]
    #[inline(always)]
    pub fn icenable(&mut self) -> IcenableW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
        IcenableW::new(self, 11)
    }
    #[doc = "Bits 12:16 - One-shot generator reference current trimming signal."]
    #[inline(always)]
    pub fn tmos(&mut self) -> TmosW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
        TmosW::new(self, 12)
    }
    #[doc = "Bit 17 - Disable Current sensing."]
    #[inline(always)]
    pub fn disableisense(
        &mut self,
    ) -> DisableisenseW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
        DisableisenseW::new(self, 17)
    }
    #[doc = "Bits 18:21 - Set output regulation voltage."]
    #[inline(always)]
    pub fn vout(&mut self) -> VoutW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
        VoutW::new(self, 18)
    }
    #[doc = "Bit 22 - Enable staggered switching of power switches."]
    #[inline(always)]
    pub fn slicingenable(
        &mut self,
    ) -> SlicingenableW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
    ...
    pub fn inductorclampenable(
        &mut self,
    ) -> InductorclampenableW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
        InductorclampenableW::new(self, 23)
    }
    #[doc = "Bits 24:27 - Set output regulation voltage during Deep Sleep."]
    #[inline(always)]
    pub fn vout_pwd(&mut self) -> VoutPwdW<'_, DcdcPowerProfileHighDcdcPowerProfileHigh0Spec> {
        VoutPwdW::new(self, 24)
    }
}
#[doc = "no description available\n\nYou can [`read`](crate::Reg::read) this register and get [`dcdc_power_profile_high_dcdc_power_profile_high_0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dcdc_power_profile_high_dcdc_power_profile_high_0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DcdcPowerProfileHighDcdcPowerProfileHigh0Spec;
impl crate::RegisterSpec for DcdcPowerProfileHighDcdcPowerProfileHigh0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dcdc_power_profile_high_dcdc_power_profile_high_0::R`](R) reader structure"]
impl crate::Readable for DcdcPowerProfileHighDcdcPowerProfileHigh0Spec {}
#[doc = "`write(|w| ..)` method takes [`dcdc_power_profile_high_dcdc_power_profile_high_0::W`](W) writer structure"]
impl crate::Writable for DcdcPowerProfileHighDcdcPowerProfileHigh0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets DCDC_POWER_PROFILE_HIGH_0 to value 0"]
impl crate::Resettable for DcdcPowerProfileHighDcdcPowerProfileHigh0Spec {}
