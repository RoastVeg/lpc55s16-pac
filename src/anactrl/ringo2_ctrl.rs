...
impl W {
    #[doc = "Bit 0 - Select short or long ringo (for all ringos types)."]
    #[inline(always)]
    pub fn s(&mut self) -> SW<'_, Ringo2CtrlSpec> {
        SW::new(self, 0)
    }
    #[doc = "Bit 1 - Ringo frequency output divider."]
    #[inline(always)]
    pub fn fs(&mut self) -> FsW<'_, Ringo2CtrlSpec> {
        FsW::new(self, 1)
    }
    #[doc = "Bit 2 - Ringo module Power control."]
    #[inline(always)]
    pub fn pd(&mut self) -> PdW<'_, Ringo2CtrlSpec> {
        PdW::new(self, 2)
    }
    #[doc = "Bit 3 - ."]
    #[inline(always)]
    pub fn e_r24(&mut self) -> ER24W<'_, Ringo2CtrlSpec> {
        ER24W::new(self, 3)
    }
    #[doc = "Bit 4 - ."]
    #[inline(always)]
    pub fn e_r35(&mut self) -> ER35W<'_, Ringo2CtrlSpec> {
        ER35W::new(self, 4)
    }
    #[doc = "Bit 5 - Metal 2 (M2) monitor control."]
    #[inline(always)]
    pub fn e_m2(&mut self) -> EM2W<'_, Ringo2CtrlSpec> {
        EM2W::new(self, 5)
    }
    #[doc = "Bit 6 - Metal 3 (M3) monitor control."]
    #[inline(always)]
    pub fn e_m3(&mut self) -> EM3W<'_, Ringo2CtrlSpec> {
        EM3W::new(self, 6)
    }
    #[doc = "Bit 7 - Metal 4 (M4) monitor control."]
    #[inline(always)]
    pub fn e_m4(&mut self) -> EM4W<'_, Ringo2CtrlSpec> {
        EM4W::new(self, 7)
    }
    #[doc = "Bit 8 - Metal 5 (M5) monitor control."]
    #[inline(always)]
    pub fn e_m5(&mut self) -> EM5W<'_, Ringo2CtrlSpec> {
        EM5W::new(self, 8)
    }
    #[doc = "Bits 16:19 - Ringo out Clock divider value. Frequency Output = Frequency input / (DIViSOR+1). (minimum = Frequency input / 16)"]
    #[inline(always)]
    pub fn divisor(&mut self) -> DivisorW<'_, Ringo2CtrlSpec> {
