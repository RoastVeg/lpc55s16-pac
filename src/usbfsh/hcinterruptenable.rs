...
impl W {
    #[doc = "Bit 0 - Scheduling Overrun interrupt."]
    #[inline(always)]
    pub fn so(&mut self) -> SoW<'_, HcinterruptenableSpec> {
        SoW::new(self, 0)
    }
    #[doc = "Bit 1 - HcDoneHead Writeback interrupt."]
    #[inline(always)]
    pub fn wdh(&mut self) -> WdhW<'_, HcinterruptenableSpec> {
        WdhW::new(self, 1)
    }
    #[doc = "Bit 2 - Start of Frame interrupt."]
    #[inline(always)]
    pub fn sf(&mut self) -> SfW<'_, HcinterruptenableSpec> {
        SfW::new(self, 2)
    }
    #[doc = "Bit 3 - Resume Detect interrupt."]
    #[inline(always)]
    pub fn rd(&mut self) -> RdW<'_, HcinterruptenableSpec> {
        RdW::new(self, 3)
    }
    #[doc = "Bit 4 - Unrecoverable Error interrupt."]
    #[inline(always)]
    pub fn ue(&mut self) -> UeW<'_, HcinterruptenableSpec> {
        UeW::new(self, 4)
    }
    #[doc = "Bit 5 - Frame Number Overflow interrupt."]
    #[inline(always)]
    pub fn fno(&mut self) -> FnoW<'_, HcinterruptenableSpec> {
        FnoW::new(self, 5)
    }
    #[doc = "Bit 6 - Root Hub Status Change interrupt."]
    #[inline(always)]
    pub fn rhsc(&mut self) -> RhscW<'_, HcinterruptenableSpec> {
        RhscW::new(self, 6)
    }
    #[doc = "Bit 30 - Ownership Change interrupt."]
    #[inline(always)]
    pub fn oc(&mut self) -> OcW<'_, HcinterruptenableSpec> {
        OcW::new(self, 30)
    }
    #[doc = "Bit 31 - Master Interrupt Enable."]
    #[inline(always)]
    pub fn mie(&mut self) -> MieW<'_, HcinterruptenableSpec> {
        MieW::new(self, 31)
    }
}
